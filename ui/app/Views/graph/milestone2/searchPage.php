...
<body class="gray-bg" style="background-color: #000011!important;">
    ...
    <div class="justify-content-center centered">
        <div class="w-100">
            <img src="<?=base_url()?>/public/layout/logo/LOGOALB_mare_MBDisc.png" style="height: 100px; display: block; margin: auto; opacity: 1;">
        </div>
        <div class="w-100">
                ...
                <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1">
                    ...
                    <div id="kt_header_search" style="margin: auto; margin-top: 10px; width: 70%" class="header-search d-flex align-items-center pt-5"  data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="true" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
                        ...
                        <form data-kt-search-element="form" class="d-none d-lg-block w-100 position-relative mb-5 mb-lg-0" autocomplete="off"
                              action="<?=base_url('graph/graph/milestone2Search/Ukraine does not exist')?>" method="get">
                                ...
                                <div class="" data-kt-search-element="main">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-325px">
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                                <a href="<?=base_url('graph/graph/milestone2Search/Ukraine does not exist')?>" class="w-100 fs-6 text-gray-800 text-hover-primary fw-semibold">Ukraine does not exist</a>
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-5">
                                            <!--begin::Title-->
                                                <a href="<?=base_url('graph/graph/milestone2Search/Ukraine does not exist')?>" class="w-100 fs-6 text-gray-800 text-hover-primary fw-semibold">EU is anti Russia</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-5">
                                            <a href="<?=base_url('graph/graph/milestone2Search/Ukraine does not exist')?>" class="w-100 fs-6 text-gray-800 text-hover-primary fw-semibold">Klaus Iohannis</a>
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="d-flex align-items-center mb-5">
                                            <!--begin::Title-->
                                            <a href="<?=base_url('graph/graph/milestone2Search/Ukraine does not exist')?>" class="w-100 fs-6 text-gray-800 text-hover-primary fw-semibold">USA is evil</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Item-->
                                    </div>
    ...
    <!--end::Header main-->
<!--<a href="#" class="float float-filter" id="btnShowFilter">
    <i class="bi bi-bar-chart-line-fill my-float"></i>
</a>-->
...
<script type="module" src="<?=base_url()?>/public/layout/graph/js/milestone2/init_big_graph.js"></script>
